...
0 & 1
\end{bmatrix}
$$ | Shifts points horizontally by an amount proportional to their height. |
| **Vertical shear** | $$
\begin{bmatrix}
1 & 0\\
k & 1
\end{bmatrix}$$ | Shifts points vertically by an amount proportional to their x-coordinate. |
